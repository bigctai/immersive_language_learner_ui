...
The UI is built using React. Translations are created by the backend via the Google Translate API, and conversation is provided via OpenAI. This is completely abstracted from the frontend.
